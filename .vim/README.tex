...
syntax match typescriptClassAndObjectProperty /\.\zs\w*\ze\(\.\|;\|\[\|\s\)/ contained containedin=typescriptBlock nextgroup=typescriptAssign,typescriptFuncCall,typescriptDotNotation
```
